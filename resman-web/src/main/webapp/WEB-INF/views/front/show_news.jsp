...
<div class="main_content">
    ...
    <div class="content_right">
        ...
        <div class="news_list">
            ...
            <ul class="relevant">
                <c:if test="${pre!=null}">
                    <li><strong>上一篇:</strong><a href="${ctx}/front/news/${pre.id}?type=${type}">${pre.title}</a></li>
                </c:if>
                <c:if test="${next!=null}">
                    <li><strong>下一篇:</strong><a href="${ctx}/front/news/${next.id}?type=${type}">${next.title}</a></li>
                </c:if>
            </ul>
        </div>
