...
<div class="main_content">
    ...
    <div class="content_right">
        <div class="position">
            ...
            <div class="position_nav"> 您现在的位置 : 首页 / <B>作业上传</B> / 列表

                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;

                <a href="${ctx}/front/myhomework"><b>我的作业</b></a>

            </div>
        </div>
        <div class="news_list">
           <ul>
                <c:if test="${fn:length(homework)>0}">
                    <c:forEach items="${homework}" var="n">
                        <li><span><fmt:formatDate value="${n.publishDate}" pattern="yyyy-MM-dd"></fmt:formatDate></span> · <a href="${ctx}/front/homework/${n.id}">${n.name}</a></li>
                    </c:forEach>
                </c:if>
        ...
        <div class="pages">
            ...
            <c:choose>
                <c:when test="${curPage-1 >= 0}">
                    <a href="${ctx}/front/homework?page=${curPage-1}">上一页</a>
                </c:when>
                <c:otherwise>
                    <a href="#">上一页</a>
                </c:otherwise>
            ...
            <c:forEach begin="${start}" end="${end}" varStatus="st">
                <a href="${ctx}/front/homework/?page=${st.current-1}" <c:if test="${st.current-1 == curPage}">class="curr" </c:if> >${st.current}</a>
            </c:forEach>

            <c:choose>
                <c:when test="${curPage+1 < totalPage}">
                    <a href="${ctx}/front/homework?page=${curPage+1}">下一页</a>
                </c:when>
                <c:otherwise>
                    <a href="#">下一页</a>
                </c:otherwise>
