...
<div class="main_content">
    ...
    <div class="content_right">
        <div class="position">
            ...
            <div class="position_nav"> 您现在的位置 : 首页 / <B>我的作业</B> / 列表
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;

                <a href="${ctx}/front/homework"><b>作业上传</b></a>
            </div>
        </div>
        <div class="news_list">
           <ul>
               ...
               <div class="tables">
                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
                       <tr>
                           <td class="thead">作业名称</td>
                           <td class="thead">发布者</td>
                           <td class="thead">发布时间</td>
                           <td class="thead">文件名称</td>
                           <td class="thead">作业分数</td>
                           <td class="thead">操作</td>
                       </tr>
                       <c:forEach var="res" items="${homework}">
                           <tr>
                               <td class="ta">${res.name}</td>
                               <td class="ta">${res.submitter}</td>
                               <td class="ta"><fmt:formatDate value="${res.submitDate}" pattern="yyyy-MM-dd"></fmt:formatDate></td>
                               <td class="ta">${res.fileName}</td>
                               <td class="ta"><font color="red">${res.score}</font> </td>
                               <td class="ta"> <a href="${ctx}/res/document/download?uuid=${res.docUid}" target="_blank">下载</a></td>
                           </tr>
                       </c:forEach>
                   </table>
        ...
        <div class="pages">
            ...
            <c:choose>
                <c:when test="${curPage-1 >= 0}">
                    <a href="${ctx}/front/myhomework?page=${curPage-1}">上一页</a>
                </c:when>
                <c:otherwise>
                    <a href="#">上一页</a>
                </c:otherwise>
            ...
            <c:forEach begin="${start}" end="${end}" varStatus="st">
                <a href="${ctx}/front/myhomework/?page=${st.current-1}" <c:if test="${st.current-1 == curPage}">class="curr" </c:if> >${st.current}</a>
            </c:forEach>

            <c:choose>
                <c:when test="${curPage+1 < totalPage}">
                    <a href="${ctx}/front/myhomework?page=${curPage+1}">下一页</a>
                </c:when>
                <c:otherwise>
                    <a href="#">下一页</a>
                </c:otherwise>
