    ...
    <div class="content_right">
        ...
        <div class="news_list">
            <c:if test="${fn:length(infos)>0}">
                ...
                <dl>
                    ...
                    <dd class="news_first_title"><a href="${ctx}/front/teachers/${n.id}">${n.title}</a></dd>
                    <dd>
                        ${n.shortContent}
                    </dd>
                    <dd class="news_first_more"><a href="${ctx}/front/teachers/${n.id}">查看详细+</a></dd>
                    </dt>
        ...
        <div class="pages">
            ...
            <c:forEach begin="${start}" end="${end}" varStatus="st">
                <a href="${ctx}/front/teachers/?page=${st.current-1}" <c:if test="${st.current-1 == curPage}">class="curr" </c:if> >${st.current}</a>
            </c:forEach>
