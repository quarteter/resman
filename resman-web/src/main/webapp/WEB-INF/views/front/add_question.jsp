...
<div class="main_content">
    ...
    <div class="content_right">
        <div class="position">
            ...
            <div class="position_nav"> 您现在的位置 : 首页 / <a href="${ctx}/front/question"> 问 答 </a> / 新建问答</div>
        </div>
        <div class="news_list">
            <form id="addquestion" action="${ctx}/front/question/save" method="post" >
                <div class="tables">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            <td class="thead" width="10%" >标题：</td>
                            <td class="ta"><input type="text" style="width:500px;" id="title" name="title"></td>
                        </tr>

                        <tr>
                            <td class="thead"  width="10%" >内容:</td>
                            <td class="ta" >
                                <script id="editor11" name="content" id="content" style="height: 350px;width:500px;" type="text/plain"></script>
                            </td>
                        </tr>

                        <tr>
                            <td class="thead" colspan="2" align="center">
                                <input type="submit" id="questionSubmit" value="提交">
                                &nbsp; &nbsp;
