...
<div class="main_content">
    ...
    <div class="content_right">
        <div class="position">
            ...
            <div class="position_nav"> 您现在的位置 : 首页 /<a href="${ctx}/front/question"> <b>问答</b> </a>/ 详情
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                <c:if test="${canedit==true}">
                    <a href="${ctx}/front/question/edit/${question.id}" ><font color="red"><b>修改问题</b></font></a>
                </c:if>
        ...
        <div class="news_list">
            ...
            <div class="date">提问者：${question.username}
           ...
           <ul>
                <c:if test="${fn:length(answer)>0}">
                    <c:forEach items="${answer}" var="n">
                        <div>(回答人：${n.crtuser.name})  <b>[<fmt:formatDate value="${n.crtdate}" pattern="yyyy-MM-dd"></fmt:formatDate>]</b></div>
                        <div>${n.content}</div>
                        <li></li>
                    </c:forEach>
                </c:if>
        ...
        <div class="pages">
            <a href="#">共${totalCount}条答复 </a>
            <c:choose>
                <c:when test="${curPage-1 >= 0}">
                    <a href="${ctx}/front/ques/${question.id}?page=${curPage-1}">上一页</a>
                </c:when>
                <c:otherwise>
                    <a href="#">上一页</a>
                </c:otherwise>
            ...
            <c:forEach begin="${start}" end="${end}" varStatus="st">
                <a href="${ctx}/front/ques/${question.id}?page=${st.current-1}" <c:if test="${st.current-1 == curPage}">class="curr" </c:if> >${st.current}</a>
            </c:forEach>

            <c:choose>
                <c:when test="${curPage+1 < totalPage}">
                    <a href="${ctx}/front/ques/${question.id}?page=${curPage+1}">下一页</a>
                </c:when>
                <c:otherwise>
                    <a href="#">下一页</a>
                </c:otherwise>
