...
<div class="main_content">
    ...
    <div class="content_right">
        <div class="position">
            ...
            <div class="position_nav"> 您现在的位置 : 首页 / <b>我的问答</b> / 列表

                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;

                <a href="${ctx}/front/question"><b>所有问答</b></a>
                ...
                <c:if test="${fn:length(question)>0}">
                    <c:forEach items="${question}" var="n">
                        <li><span>[
                            ...
                            ]&nbsp;<fmt:formatDate value="${n.crtdate}" pattern="yyyy-MM-dd"></fmt:formatDate></span> · <a href="${ctx}/front/ques/${n.id}">${n.title}(回复数：<b>${n.rescount}</b>)</a></li>
                    </c:forEach>
                </c:if>
        ...
        <div class="pages">
            ...
            <c:choose>
                <c:when test="${curPage-1 >= 0}">
                    <a href="${ctx}/front/myquestion?page=${curPage-1}">上一页</a>
                </c:when>
                <c:otherwise>
                    <a href="#">上一页</a>
                </c:otherwise>
            ...
            <c:forEach begin="${start}" end="${end}" varStatus="st">
                <a href="${ctx}/front/myquestion/?page=${st.current-1}" <c:if test="${st.current-1 == curPage}">class="curr" </c:if> >${st.current}</a>
            </c:forEach>

            <c:choose>
                <c:when test="${curPage+1 < totalPage}">
                    <a href="${ctx}/front/myquestion?page=${curPage+1}">下一页</a>
                </c:when>
                <c:otherwise>
                    <a href="#">下一页</a>
                </c:otherwise>
