...
<aside class="right-side">
    ...
    <section class="content">
        <form class="form-horizontal" role="form" method="post" action="${ctx}/sys/perm/add" id="permForm">
            <input id="id" type="hidden" name="id" value="${perm.id}"/>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="name">权限名</label>

                <div class="col-sm-4">
                    <input id="name" class="form-control" name="name" value="${perm.name}"/>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input id="resource" class="form-control" name="resource" value="${perm.resource}"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input id="permission" class="form-control" name="permission" value="${perm.permission}"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <textarea id="notes" class="form-control" rows="3" >${perm.notes}</textarea>
                </div>
            </div>
