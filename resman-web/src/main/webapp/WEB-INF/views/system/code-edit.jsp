    ...
    <section class="content">
        <form class="form-horizontal" role="form" method="post" id="codeForm" action="${ctx}/sys/code/add">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input id="category" class="form-control" name="category" value="${code.category}"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input id="code" class="form-control" name="code" value="${code.code}"/>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input id="name" class="form-control" name="name" value="${code.name}"/>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input id="seqNo" class="form-control" name="seqNo" value="${code.seqNo}"/>
                </div>
            </div>
