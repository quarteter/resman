...
<aside class="right-side">
    ...
    <section class="content">
        <form class="form-horizontal" role="form" method="post" action="${ctx}/sys/role/add" id="roleForm">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input id="role" class="form-control" name="role" value="${role.role}"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <textarea id="notes" class="form-control" rows="3">${role.notes}</textarea>
                </div>
            </div>
