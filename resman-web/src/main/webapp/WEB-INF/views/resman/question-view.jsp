        ...
        function bindSubmit() {
            $("#btnSubmit").on("click", function () {
                if ($("#questionForm").valid()) {
                    $.post('/res/question/update',$('#questionForm').serializeJson(), function(data){
                        if(data.success){
                            tipSuccess("操作成功");
    ...
    <section class="content">
        <form class="form-horizontal" role="form" method="post" id="questionForm">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input id="state" class="form-control" name="state" disabled value = "${question.crtuser.name}"/>
                </div>

            </div>

            <div class="form-group">
                <label class="col-sm-2 control-label" for="crtdate">发布时间</label>

                <div class="col-sm-4">
                    <input id="crtdate" class="form-control" name="crtdate" disabled value = "${question.crtdate}"/>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <script id="editor11" name="content" style="height: 350px;" type="text/plain"  >${question.content} </script>
                </div>
            </div>
