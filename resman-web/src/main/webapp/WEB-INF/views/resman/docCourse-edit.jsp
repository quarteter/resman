...
<aside class="right-side">
    ...
    <section class="content">
        <form class="form-horizontal" role="form" method="post" id="courseForm">
            ...
            <input type="hidden" name="docUid" value="${course.docUid}"/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input id="teacher" class="form-control" name="teacher" value="${course.teacher}"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <textarea id="brief" class="form-control" name="brief" rows="5">${course.brief}</textarea>
                </div>
            </div>
